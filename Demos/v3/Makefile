...
clean-pc:
	rm -f *.o $(TARGET)
	rm -f "saves/SAVE_DEMO3.s"

$(TARGET):
	gcc -g -Wall -c -o crayon.o crayon.c
	gcc -g -Wall -c -o savefile.o savefile.c
	gcc -g -Wall -c -o graphics.o graphics.c
	gcc -g -Wall -c -o setup.o setup.c
